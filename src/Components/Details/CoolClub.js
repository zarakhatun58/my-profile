  ...
  return (
    <div>
      <div className="row mt-2 row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
        ...
        <div className="col mt-3">
          <h3 className="project-title">Cool Club Business</h3>
          ...
          <div className="project-detailsP">
            ...
            <li>
              ...
              js,Express js, MongoDB, Heroku, SQL, Microsoft Graph Api ,
              Sharepoint
            </li>
          </div>
        </div>
        <div className="text-center w-100 m-auto">
          <button className="btn btn-info project-button">
            <a target="blank" href="https://coolclub.taqeef.com/">
              Live Preview
            </a>
          </button>
